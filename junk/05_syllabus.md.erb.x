---
title: (Draft) Cosi105 - Scalability 2022 Syllabus 
---
#### Summary info
<% tbh = TableHelper.new("table-striped table-sm table-responsive table-hover") %>
<% tbh.headers("", "") %>
<% tbh.row("Instructor", "Pito Salas <rpsalas@brandeis.edu>") %>
<% tbh.row("Location", "TBD") %>
<% tbh.row("Office Hours", "Go to this link to reserve an appointment: https://calendly.com/pitosalas/chat") %>
<% tbh.row("Class Times", "Tuesday and Thursday, 3:30pm to 5:00pm") %>
<% tbh.row("Location", "TBD") %>
...
:topic_include :syllabus_add_drop_policy

### Other useful information

* :topic_link :cosi105b_goals
* :topic_link :cosi105b_grading
* :topic_link :experiential
